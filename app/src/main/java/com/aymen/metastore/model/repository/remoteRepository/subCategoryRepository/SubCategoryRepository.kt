...
interface SubCategoryRepository {
    ...
    suspend fun getSubCategoryByCategoryy(id : Long,companyId : Long): Response<List<SubCategory>>

    suspend fun getAllSubCategories(companyId : Long): Response<List<SubCategoryDto>>
    suspend fun getAllSubCategoriess(companyId : Long): Response<List<SubCategory>>
