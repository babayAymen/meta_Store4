...
class SubCategoryPagingSource(private val api : ServiceApi, private val sharedViewModel: SharedViewModel) : PagingSource<Int, SubCategory>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, SubCategory> {
        ...
        val response = api.getAllSubCategories(companyId = id!! ,page = currentPage, pageSize = PAGE_SIZE)
