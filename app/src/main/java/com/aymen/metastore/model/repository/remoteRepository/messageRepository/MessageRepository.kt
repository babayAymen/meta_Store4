...
interface MessageRepository {
    ...
    suspend fun getAllMyMessageByConversationId(conversationId : Long):Response<List<Message>>
    ...
    suspend fun getAllMessageByCaleeId(id : Long, typeype: AccountType): Response<List<Message>>
}